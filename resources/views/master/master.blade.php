                    ...
                    <div class="row gutter-2">
                      <div class="col-lg-2">
                        ...
                        <ul class="menu-list">
                          ...
                          <li class="menu-list-item"><a href="" class="menu-list-link">Женский</a></li>
                        </ul>
                      </div>
                      <div class="col-lg-2">
                        <span class="eyebrow text-muted mb-1">Категории</span>
                        <ul class="menu-list">
                          <li class="menu-list-item"><a href="" class="menu-list-link">Сапоги</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Туфли</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Сандали</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Кросовки</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Кеды</a></li>
                        </ul>
                      </div>
                      <div class="col-lg-2">
                        <span class="eyebrow text-muted mb-1"></span>
                        <ul class="menu-list">
                          <li class="menu-list-item"><a href="" class="menu-list-link">Ботинки</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Босоножки</a></li>
                          <li class="menu-list-item"><a href="" class="menu-list-link">Валенки</a></li>
                        </ul>
                      </div>
                      <div class="col-lg-2">
