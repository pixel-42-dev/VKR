                      ...
                      <div class="card card-data bordered">
                        <div class="card-header">
                          <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                              <span class="dropdown">
                                <button class="btn btn-lg btn-white btn-ico" id="dropdown-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button"><i class="icon-more-vertical"></i></button>
                      ...
                      <div class="card card-data bordered">
                        <div class="card-header">
                          <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                              <span class="dropdown">
                                <button class="btn btn-lg btn-white btn-ico" id="dropdown-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button"><i class="icon-more-vertical"></i></button>
